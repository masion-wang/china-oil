...
define(function (require) {
  ...
  Vue.gvUtil.setApi({
    ...
    // 单据类型
    findBybusinessNo: '/gpbillmain/findBybusinessNo',
    // 业务号
  ...
  return Vue.gvUtil.Page({
    ...
    created: function created() {
      Vue.gvUtil.initTranslation('BillingType'); // let that = this
      ...
      //     that.correspondenceList = res.resData
      //   }
      // });
      // find_other_list
    },
    ...
    methods: {
      ...
      changeschemeName2: function changeschemeName2(data) {
