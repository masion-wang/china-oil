...
define(function (require) {
  ...
  Vue.gvUtil.setApi({
    ...
    findExchange: '/policySelfMain/findExchange',
  ...
  return Vue.gvUtil.Page({
    ...
    mounted: function mounted() {
      ...
      if (this.$route.query.flag == "Approve") {
        ...
        this.$refs.baseInfo.getPolicyFeeInfo(proposalNo, versionNo, 'Approve', policyNo);
          ...
          this.status2 = 'modify';
          this.$refs.baseInfo.getPolicyFeeInfo2(_proposalNo, _versionNo, "modify", _policyNo);
        } // 查看
            ...
            this.status2 = 'Look';
            this.$refs.baseInfo.getPolicyFeeInfo3(_proposalNo2, _versionNo2, 'Look', _policyNo2);
          }
    },
    ...
    methods: {
      ...
      save: function save() {
        ...
        if (params2.guPolicyRiVoList.length == 0) {
          this.$message({
            showClose: true,
            message: '再保人信息不能空',
            type: 'warning'
        ...
        if (params2.guPolicyVoList.length == 0) {
          this.$message({
            showClose: true,
            message: '原保单信息不能空',
            type: 'warning'
        ...
        if (params2.guPolicyItemMainVoList.length == 0) {
          this.$message({
            showClose: true,
            message: '原保单信息不能空',
            type: 'warning'
