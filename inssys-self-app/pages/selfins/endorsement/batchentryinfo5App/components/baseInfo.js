  ...
  return Vue.gvUtil.Page({
    ...
    datas: function () {
      return {
        ...
        stateWord: "",
        premiumList2: [],
        IsfiveExport: false, // 三个  stateWord:'',险种是否被导入 MAR EAS OOPU
    ...
    methods: {
      ...
      gettotalDue2(selfInsuranceRate, totalDue, riShareValue, index1, index2) {
        ...
        this.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[index2].annualPremium = (totalDue / (selfInsuranceRate * 0.01)).toFixed(2)
        this.Cal()
          ...
          if (res.resCode == "0000") {
            if (res.resCode == "0000") {
              ...
              that.Clause.guPolicyClauseVoList =
                res.resData.guPolicyClauseVoList;
