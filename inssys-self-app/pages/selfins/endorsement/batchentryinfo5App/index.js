  ...
  return Vue.gvUtil.Page({
    ...
    methods: {
      ...
      save() {
        ...
        // 条款数组
        params2.guPolicyClauseVoList = this.$refs.baseInfo.Clause.guPolicyClauseVoList;
        // 标的数组
        ...
        if (this.valid == true) {
          ...
          if (params2.guPolicyVoList[0].cedingRiskCode == 'O-OCI' ||
            ...
            if (!params2.maintenancePeriods || (params2.maintenancePeriods && params2.maintenancePeriods.length != 2)) {
              this.$message({
                showClose: true,
                message: '维护期不能为空',
                type: 'warn'
      ...
      submit() {
        ...
        params2.guPolicyItemMainVoList = this.$refs.baseInfo.underlying.guPolicyItemMainVoList;
        // 维护期判断
        if (params2.guPolicyItemMainVoList[0].riskCode == 'CARD' || params2.guPolicyItemMainVoList[0].riskCode == 'CARU') {
          if ((params2.maintenancePeriods && params2.maintenancePeriods.length != 2) || params2.maintenancePeriods == null) {
            this.$confirm('维护期未录入,是否继续', '提示', {
              ...
              // 分期对象
              params2.guInstallmentForPolicyVo = {};
              params2.guInstallmentForPolicyVo.guInstallmentRiVo = that.$refs.baseInfo.guInstallmentForPolicyVo.guInstallmentRiVo;
              params2.guInstallmentForPolicyVo.guInstallmentRoVoList = that.$refs.baseInfo.fqPayee.guInstallmentRoVoList;
              console.log("params2", params2);
              // 如果有条款
              if (params2.guPolicyClauseVoList.length > 0) {
                // 遍历再保人 给再保人对象塞进去数组
                for (let item of params2.guPolicyRiVoList) {
                  item.guPolicyClauseVoList = that.$refs.baseInfo.Clause.guPolicyClauseVoList;
                }
              }
              // 增加审核人+工作流
