...
define(function (require) {
  ...
  return Vue.gvUtil.Page({
    ...
    created: function created() {
      ...
      Vue.gvUtil.initTranslation("Currency"); // 获取上年保单号
      ...
      getPolicyFeeInfo: function getPolicyFeeInfo(row, flag) {
        ...
        Vue.gvUtil.http.post(url, params).then(function (res) {
          ...
          if (res.resCode == "0000") {
            ...
            that.guPolicyItemMainVoListThree = res.resData.guPolicyItemMainVoList; //如果审核通过可以打印

            that.$emit("PrintandschemeFor", that.baseInfo.policyStatus); // 如果是冲销过来的
            ...
            that.baseInfo.endorsementEffectiveDate = row.endorsementEffectiveDate; // 文档资料
      ...
      getPolicyFeeInfo11: function getPolicyFeeInfo11() {
        ...
        Vue.gvUtil.http.post(url, params).then(function (res) {
          ...
          if (res.resCode == "0000") {
            ...
            that.baseInfo.cedingCurrency = "02"; // 有效批改日期 类型
      ...
      getPolicyFeeInfo3: function getPolicyFeeInfo3(proposalNo, versionNo, word, policyNo) {
        ...
        Vue.gvUtil.http.post(url, params).then(function (res) {
          if (res.resCode == "0000") {
            ...
            _this4.$emit("fromChild", res.resData.guPolicyAllInfo.ggDocumentList);
      ...
      goAudit: function goAudit(code) {
        ...
        this.$refs.auditInfo.validate(function (valid) {
          if (valid) {
            ...
            var s = _this8.checkboxGroup.toString(); //将选中的值Tostring赋给param2
        ...
        if (that.baseInfo.riskCode != "EAS" && that.baseInfo.riskCode != "MAR" && that.baseInfo.riskCode != "OOPU") {
          ...
          Vue.gvUtil.http.post(url, formData).then(function (res) {
            ...
            if (that.baseInfo.riskCode == "EAS" || that.baseInfo.riskCode == "MAR" || that.baseInfo.riskCode == "OOPU") {
              ...
              try {
                for (var _iterator14 = that.underlying.guPolicyItemMainVoList[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
        ...
        this.$refs.fqfrom.validate(function (valid) {
          ...
          if (valid) {
            ...
            if (that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList && that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList.length >= 1) {
              ...
              try {
                for (var _iterator15 = that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
    ...
    events: {
      ...
      savePeriodizationOut: function savePeriodizationOut() {
        ...
        this.$refs.fqfrom.validate(function (valid) {
          if (valid) {
            _this12.fqPayee.guInstallmentRoVoList[_this12.guInstallmentDetailVoListindex].fqPayee.guInstallmentDetailVoList = _this12.fqPayee.guInstallmentDetailVoList;
            _this12.stagingInformationVisible = false;
          }
        });
      },
      //为表格表头添加星号样式
