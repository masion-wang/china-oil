  ...
  return Vue.gvUtil.Page({
    ...
    datas: function () {
      return {
        ...
        guInstallmentDetailVoListindex: "", //点击分期全局index
    ...
    methods: {
      ...
      blur55(value, index) {
        let that = this
        let selfInsuranceRate = this.fromData.guPolicyRiVoList[index].selfInsuranceRate
      ...
      dateFormatChange(date) {
        ...
        let newDate = temp2[2] + '-' + temp2[1] + '-' + temp2[0] + ' ' + temp1[1]
      ...
      getCilShareValue(insuredValue, cilShare, totalDue, index1) {
        ...
        if (that.baseInfo.riskCode == "MAR") {
          ...
          this.underlying.guPolicyItemMainVoList[
            index1
          ].guPolicyItemCedingVo.cilShareValue = (insuredValue * cilShare * 0.01).toFixed(2) //  /length
        } else {
          this.underlying.guPolicyItemMainVoList[
            index1
      ...
      // 自保费率=自保分入净保费/自保保额
      // 自保毛保费  = 自保分入净保费+ 自保佣金
      getcilRate(oriAnnualPremium, cilShare, totalDue, cilShareValue, oriMonths, insuredDay, index1) {
        console.log('oriAnnualPremium, depthft', oriAnnualPremium, this.underlying.guPolicyItemMainVoList[
          index1
        ].depthft)
        ...
        if (this.baseInfo.riskCode == 'OEE') {
          let oriAnnualPremium = this.underlying.guPolicyItemMainVoList[
            index1
          ].guPolicyItemCedingVo.oriAnnualPremium
          let depthft = this.underlying.guPolicyItemMainVoList[index1].depthft
          this.underlying.guPolicyItemMainVoList[
            index1
          ].guPolicyItemCedingVo.cilRate = (oriAnnualPremium / depthft).toFixed(6)
        } else {
          // 自保费率
          this.underlying.guPolicyItemMainVoList[
            index1
          ].guPolicyItemCedingVo.cilRate = (totalDue / cilShareValue).toFixed(6);
        }
      ...
      getoriPerMonth2(
        ...
        console.log('totalDue / cilShareValue', totalDue, cilShareValue, this.underlying.guPolicyItemMainVoList[
          index1
        ].guPolicyItemCedingVo.cilRate)
        // 月保费 年保费
        this.underlying.guPolicyItemMainVoList[
          index1
        ].guPolicyItemCedingVo.oriPerMonth = (
      ...
      getriOriGrossPremium(selfInsuranceRate, overrideRate, index1, index2) {
        ...
        this.underlying.guPolicyItemMainVoList[
          index1
        ].guPolicyItemReinsVoList[index2].annualPremium = (
          totalDue / (selfInsuranceRate * 0.01)
      ...
      getriOriGrossPremium2(commission, totalDue, index1, index2) {
        ...
        if (that.baseInfo.riskCode == 'CARD' || that.baseInfo.riskCode == 'CARU') {
          this.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[
            index2
          ].totalPremium = Number(totalDue) + Number(that.underlying.guPolicyItemMainVoList[index1]
            .guPolicyItemReinsVoList[index2].mws) + Number(Number(commission).toFixed(2))
        } else {
          ...
          this.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[
            index2
          ].totalPremium = Number(totalDue) + Number(Number(commission).toFixed(2))
      ...
      gettotalDue2(selfInsuranceRate, totalDue, riShareValue, index1, index2) {
        ...
        if (that.baseInfo.riskCode == 'CARD' || that.baseInfo.riskCode == 'CARU') {
          that.underlying.guPolicyItemMainVoList[index1]
            .guPolicyItemReinsVoList[index2].totalPremium = Number(Number(that.underlying.guPolicyItemMainVoList[index1]
              .guPolicyItemReinsVoList[index2].commission).toFixed(2)) + Number(that.underlying.guPolicyItemMainVoList[index1]
              .guPolicyItemReinsVoList[index2].mws) + Number(totalDue)
        } else {
          that.underlying.guPolicyItemMainVoList[index1]
            .guPolicyItemReinsVoList[index2].totalPremium = Number(Number(that.underlying.guPolicyItemMainVoList[index1]
              .guPolicyItemReinsVoList[index2].commission).toFixed(2)) + Number(totalDue)


        }

        that.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[index2].annualPremium = Number((totalDue / (selfInsuranceRate * 0.01)).toFixed(2))
        console.log('this.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[index2].annualPremium',this.underlying.guPolicyItemMainVoList[index1].guPolicyItemReinsVoList[index2])
        this.Cal()
      ...
      getmws(mws, totalDue, index1, index2) {
        ...
        if (that.baseInfo.riskCode == 'CARD' || that.baseInfo.riskCode == 'CARU') {
          that.underlying.guPolicyItemMainVoList[index1]
            .guPolicyItemReinsVoList[index2].totalPremium = Number(Number(that.underlying.guPolicyItemMainVoList[index1]
              .guPolicyItemReinsVoList[index2].commission).toFixed(2)) + Number(mws) + Number(totalDue)
        }
        // 否则啥也不干
      },
      // 获取随机唯一数
      ...
      getPolicyFeeInfo(row, flag) {
        ...
        Vue.gvUtil.http.post(url, params).then((res) => {
          ...
          if (res.resCode == "0000") {
            ...
            that.guPolicyItemMainVoListThree = res.resData.guPolicyItemMainVoList;
            ...
            // 分期分入 guInstallmentForPolicyVo guInstallmentRiVo
      ...
      getPolicyFeeInfo11() {
        ...
        Vue.gvUtil.http.post(url, params).then((res) => {
          ...
          if (res.resCode == "0000") {
            ...
            that.baseInfo.cedingCurrency = "02";
            // 有效批改日期 类型
            // that.baseInfo.endorsementEffectiveDate = row.endorsementEffectiveDate
            // that.baseInfo.endorsementType = row.endorsementType
            //如果审核通过可以打印
      ...
      dataFromSelectpolicyApp(obj) {
        ...
        // 干掉查询详情的再保人this.fromData.guPolicyRiVoList
        let arr1 = this.fromData.guPolicyRiVoList.filter((item) => {
        ...
        let arr2 = this.guPolicyVoList.filter((item) => {
          if (item.policyId) {} else {
            return item;
          }
        });
        // 标的数据 this.underlying.guPolicyItemMainVoList
        let arr3 = this.underlying.guPolicyItemMainVoList.filter((item) => {
        ...
        if (obj.guPolicyItemMainVoList) {
          ...
          // 2.渲染标的 必有
          this.underlying.guPolicyItemMainVoList = this.underlying.guPolicyItemMainVoList.concat(
          ...
          console.log("再保人", arr);
          this.fromData.guPolicyRiVoList = this.fromData.guPolicyRiVoList.concat(
            arr
          );
          this.fqPayee.guInstallmentRoVoList = this.fqPayee.guInstallmentRoVoList.concat(
            arr
          );
      ...
      removesingle(data, index) {
        console.log("再保人单个删除", data, this.fromData.guPolicyRiVoList);
        ...
        // }
        // 删除标的
        let arrbiao = this.underlying.guPolicyItemMainVoList.filter((item) => {
          if (item.random == data.random) {} else {
            return item;
          }
        });
        this.underlying.guPolicyItemMainVoList = arrbiao;
        // 删除再保人
        let arrzai = this.fromData.guPolicyRiVoList.filter((item) => {
          if (item.random == data.random) {} else {
            return item;
          }
        });
        this.fromData.guPolicyRiVoList = arrzai;

        // if (this.fromData.guPolicyRiVoList[index] instanceof Object) {
      ...
      importExcel(file) {
        ...
        let overrideRateArr = [];
        console.log("guPolicyRiVoList", that.fromData.guPolicyRiVoList);
      ...
      importClauseExcel(file) {
        ...
        Vue.gvUtil.http.post(url, formData).then((res) => {
          ...
          that.Clause.guPolicyClauseVoList = that.Clause.guPolicyClauseVoList.concat(
            res.resData
          );
      ...
      openClause(index) {
        ...
        this.reinsurerCode = this.fromData.guPolicyRiVoList[
          index
        ].reinsurerCode;
        ...
        this.$refs.fqfrom.validate((valid) => {
          ...
          if (valid) {
            ...
            if (that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList && that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList.length >= 1) {
              let scope = 0
              // 分期 分入批次相加必须为100
              for (let item of that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList) {
      ...
      savePeriodizationOut() {
        ...
        this.$refs.fqfrom.validate((valid) => {
          if (valid) {
            this.fqPayee.guInstallmentRoVoList[
              this.guInstallmentDetailVoListindex
            ].fqPayee.guInstallmentDetailVoList = this.fqPayee.guInstallmentDetailVoList;
