  ...
  return Vue.gvUtil.Page({
    ...
    mounted: function mounted() {
      if (this.$route.query.pageType == "amend") {
        ...
        this.$route.query;
        this.$refs.baseInfo.getPolicyFeeInfo(this.$route.query.row, this.$route.query.flag);
      } // // 修改
    ...
    methods: {
      ...
      save: function save() {
        ...
        params2.guInstallmentForPolicyVo.guInstallmentRoVoList = this.$refs.baseInfo.fqPayee.guInstallmentRoVoList; // 分期分入不能为空
        // guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList
        // 遍历分期分出数组 判断不能为空
      ...
      submit: function submit() {
        ...
        params2 = this.$refs.baseInfo.baseInfo;
        params2.insuredCode = params2.insured; // 原保单数组
