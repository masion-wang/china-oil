...
define(function (require) {
  ...
  Vue.gvUtil.setApi({
    ...
    // 下载pdf
    addFileNoEntryNodeendor: '/guPolicyFee/addFileNoEntryNode' // 补录文档资料-保单
      ...
      if (this.$route.query.pageType == "task") {
        ...
        // let policyNo = this.$route.query.row.policyNo
          ...
          // let policyNo = this.$route.query.row.policyNo
            ...
            this.status2 = "Look";
            this.$refs.baseInfo.getPolicyFeeInfo11("back"); // this.$refs.baseInfo.getPolicyFeeInfo3(proposalNo, versionNo, 'Look', policyNo)
    ...
    methods: {
      UPfile: function UPfile() {
        ...
        var url = Vue.gvUtil.getUrl({
          apiName: "addFileNoEntryNodeendor",
          contextName: "selfins"
        });
        var params = {
      ...
      getDialogShow: function getDialogShow(isShow, vailfFourBrother, riskCode, guPolicyVoList) {
        ...
        this.$nextTick(function () {
          ...
          _this2.$refs.selectpolicyApp.getValidFourBrother();
        ...
        if (this.valid == true) {
          ...
          Vue.gvUtil.http.post(url, params2).then(function (res) {
            ...
            if (res.resCode == "0000") {
              ...
              _this4.$alert(res.resData.proposalNo, "投保单号", {
