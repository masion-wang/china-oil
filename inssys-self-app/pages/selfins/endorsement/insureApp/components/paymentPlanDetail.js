  ...
  return Vue.gvUtil.Page({
    ...
    events: {
      selectDate: function(val,row,index) {
        ...
        if(lastPayment.some(item => {if(item.payEndTime != ''){return new Date(item.payEndTime).getTime() > new Date(val).getTime();}})) {
          this.$message({
        ...
        if(nexyPayment.some(item => {if(item.payEndTime != ''){return new Date(item.payEndTime).getTime() < new Date(val).getTime();}})) {
          this.$message({
