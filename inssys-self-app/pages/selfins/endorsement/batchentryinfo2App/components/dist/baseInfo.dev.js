  ...
  return Vue.gvUtil.Page({
    ...
    methods: {
        ...
        Vue.gvUtil.http.post(url, params).then(function (res) {
          ...
          if (res.resCode == "0000") {
            if (res.resCode == "0000") {
              ...
              that.baseInfo.endorsementType = row.endorsementType; //如果审核通过可以打印
      ...
      removeMultiguPolicyVoList: function removeMultiguPolicyVoList() {
        ...
        if (that.multipleSelection.length == 0) {
          ...
          Vue.gvUtil.confirm({
            ...
            try {
              for (var _iterator5 = that.multipleSelection[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      getunderWritingYear2: function getunderWritingYear2(date) {
        ...
        try {
          for (var _iterator7 = this.underlying.guPolicyItemMainVoList[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      ...
      importExcel: function importExcel(file) {
        ...
        try {
          for (var _iterator8 = that.fromData.guPolicyRiVoList[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        this.$refs.fqfrom.validate(function (valid) {
          ...
          if (valid) {
            ...
            if (that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList && that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList.length >= 1) {
              ...
              try {
                for (var _iterator9 = that.guInstallmentForPolicyVo.guInstallmentRiVo.guInstallmentDetailVoList[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
