...
var urlParams = getParams(document.location.search.substring(1));
//var base64 = urlParams.base64;
var base64 = "";
var xhr = new XMLHttpRequest();
var urlParams = getParams(document.location.search.substring(1));
var url = "/report/tpsgi/print/pdfBASE64?" + document.location.search.substring(1);
//var url = "/report/tpsgi/print/pdfBASE64?" + document.location.search.substring(1);
//console.log(url);
...
//     xhr.send();
// } catch (ex) {
//     base64 = '';
// }

//只读去掉两个按钮
window.onload = function() {
    var v = document.getElementById("viewBookmark");
    v.parentNode.removeChild(v);
    var o = document.getElementById("openFile");
    o.parentNode.removeChild(o);
    if (urlParams['showD'] == 'false') {
        var d = document.getElementById("download");
        d.parentNode.removeChild(d);
    }
    if (urlParams['showU'] == 'false') {
        var u = document.getElementById("upload");
        var uk = document.getElementById("uploadKey");
        u.parentNode.removeChild(u);
        uk.parentNode.removeChild(uk);
    }
    if (urlParams['showE'] == 'false') {
        var e = document.getElementById("email");
        e.parentNode.removeChild(e);
    }
    if (urlParams['showP'] == 'false') {
...
(function() {
    ...
    (function(root, factory) {
        ...
        function webViewerInitialized() {
            ...
            var file = convertDataURIToBinary(DEFAULT_URL);
            ...
            appConfig.toolbar.print.addEventListener('click', function(e) {
                if (urlParams['readonly'] == 'false') {
                    // PDFViewerApplication.eventBus.dispatch('print');
                    var ajaxs = new XMLHttpRequest();
                    ajaxs.open("GET", "/report/tpsgi/print/publicPrint?" + document.location.search.substring(1), false);
                    ajaxs.onreadystatechange = function() {
                        if (ajaxs.readyState == 4 && ajaxs.status == 200) {
                            var obj = ajaxs.responseText;
                            console.log(obj);
                            var json = JSON.parse(obj);
                            alert(json.resData.result);
                            if (typeof(json.resData.apiUrl) != 'undefined') {
                                var ajax = new XMLHttpRequest();
                                ajax.open("POST", json.resData.apiUrl, false);
                                ...
                                var postData = 'type' + '=' + json.resData.type + '&' + 'ids' + '=' + json.resData.ids;
                                ajax.send(postData);
                            }
                            if (typeof(json.resData.printDocId) != 'undefined') {
                                var ajax1 = new XMLHttpRequest();
                                ajax1.open("GET", "/claim/printDocument/sucessPrintReportByKey/" + json.resData.printDocId, false);
            ...
            appConfig.toolbar.download.addEventListener('click', function(e) {
                if (urlParams['readonly'] == 'false') {
                    ...
                    if (upload.checked) {
                        var ajax = new XMLHttpRequest();
                        ajax.open("GET", "/report/tpsgi/print/publicUpload?" + document.location.search.substring(1), false);
                        ajax.onreadystatechange = function() {
                            if (ajax.readyState == 4 && ajax.status == 200) {
                                ...
                                if (typeof(json.resData.apiUrl) != 'undefined') {
                                    var ajaxs = new XMLHttpRequest();
                                    ajaxs.open("POST", json.resData.apiUrl, false);
                                    ...
                                    var postData = 'type' + '=' + json.resData.type + '&' + 'docId' + '=' + json.resData.docId + '&' + 'downloadUrl' + '=' + json.resData.downloadUrl + '&' + 'ids' + '=' + json.resData.ids;
                                    ajaxs.send(postData);
                                }
                            }
                        }
...
function getBase64(config) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
            DEFAULT_URL = xhr.responseText;
            pdfjsWebLibs.pdfjsWebApp.PDFViewerApplication.run(config);
            loadingBlock.style.display="none";
            document.getElementById("base64").value = DEFAULT_URL;
        }
    }
    try {
        xhr.send();
    } catch (ex) {
        DEFAULT_URL = '';
        pdfjsWebLibs.pdfjsWebApp.PDFViewerApplication.run(config);
        loadingBlock.style.display="none";
    }
}
...
function email() {
    ...
    var isSuccess = false;
    var ajax = new XMLHttpRequest();
    ajax.open("GET", "/report/tpsgi/print/sendMail?" + document.location.search.substring(1), false);
    ajax.onreadystatechange = function() {
        if (ajax.readyState == 4 && ajax.status == 200) {
            isSuccess = true;
        }
    ...
    if (isSuccess && upload.checked) {
        var ajax1 = new XMLHttpRequest();
        ajax1.open("GET", "/report/tpsgi/print/publicUpload?" + document.location.search.substring(1), false);
        ajax1.onreadystatechange = function() {
